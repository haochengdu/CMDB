...
class NewAssetApprovalZone(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = "新上线待批准资产列表"
        ordering = ['-c_time']
